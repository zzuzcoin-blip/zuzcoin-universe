...
contract ZUZToken {
    ...
    constructor() { owner = msg.sender; totalSupply = 10000000 * 10**decimals; balances[msg.sender] = totalSupply; emit Transfer(address(0), msg.sender, totalSupply); }
